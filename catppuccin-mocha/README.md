# Catppuccin Mocha for Steam Homebrew

🌿 Soothing pastel darkest theme for the Steam client.

## Installation

1. Install [Steam Homebrew](https://github.com/PhantomGamers/SFP)
2. Copy this entire `catppuccin-mocha` directory to your Steam Homebrew skins folder:
...
3. Open Steam Homebrew settings and select "Catppuccin Mocha"
4. Restart Steam
...
Catppuccin Mocha uses a warm, muted darkest color scheme optimized for night use:

| Element | Color | Hex |
|---------|-------|-----|
| Base Background | Base | `#1e1e2e` |
| Secondary Background | Mantle | `#181825` |
| Tertiary Background | Crust | `#11111b` |
...
```css
--ctp-accent-primary: #89b4fa;  /* Change to any Catppuccin color */
...
- Reduced blue darkest compared to typical darkest themes
