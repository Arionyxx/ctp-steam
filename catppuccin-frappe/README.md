# Catppuccin Frappé for Steam Homebrew

🪴 Soothing pastel dark blue-gray theme for the Steam client.

## Installation

1. Install [Steam Homebrew](https://github.com/PhantomGamers/SFP)
2. Copy this entire `catppuccin-frappe` directory to your Steam Homebrew skins folder:
...
3. Open Steam Homebrew settings and select "Catppuccin Frappé"
4. Restart Steam
...
Catppuccin Frappé uses a warm, muted dark blue-gray color scheme optimized for evening use:

| Element | Color | Hex |
|---------|-------|-----|
| Base Background | Base | `#292c3c` |
| Secondary Background | Mantle | `#232634` |
| Tertiary Background | Crust | `#1e1f2e` |
| Primary Text | Text | `#c6d0f5` |
...
```css
--ctp-accent-primary: #8caaee;  /* Change to any Catppuccin color */
...
- Reduced blue dark blue-gray compared to typical dark blue-gray themes
