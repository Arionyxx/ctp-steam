# Catppuccin Mocha for Steambrew

The darkest Catppuccin flavor with rich contrast and soothing pastel accents.

## Preview

Mocha is the darkest of the Catppuccin flavors, perfect for late-night gaming sessions and reducing eye strain in low-light environments.
...
|-------|-----|---------|-------|
| Base | `#1e1e2e` | ![#1e1e2e](https://via.placeholder.com/50x20/1e1e2e/1e1e2e.png) | Main background |
| Mantle | `#181825` | ![#181825](https://via.placeholder.com/50x20/181825/181825.png) | Secondary background |
| Crust | `#11111b` | ![#11111b](https://via.placeholder.com/50x20/11111b/11111b.png) | Tertiary background |

### Text Colors
| Color | Hex | Preview | Usage |
|-------|-----|---------|-------|
| Text | `#cdd6f4` | ![#cdd6f4](https://via.placeholder.com/50x20/cdd6f4/cdd6f4.png) | Primary text |
| Subtext1 | `#bac2de` | ![#bac2de](https://via.placeholder.com/50x20/bac2de/bac2de.png) | Secondary text |
| Subtext0 | `#a6adc8` | ![#a6adc8](https://via.placeholder.com/50x20/a6adc8/a6adc8.png) | Muted text |

### Accent Colors
| Color | Hex | Preview | Usage |
|-------|-----|---------|-------|
| Blue | `#89b4fa` | ![#89b4fa](https://via.placeholder.com/50x20/89b4fa/89b4fa.png) | Primary accent |
| Sapphire | `#74c7ec` | ![#74c7ec](https://via.placeholder.com/50x20/74c7ec/74c7ec.png) | Hover accent |
| Lavender | `#b4befe` | ![#b4befe](https://via.placeholder.com/50x20/b4befe/b4befe.png) | Active accent |

### State Colors
| Color | Hex | Preview | Usage |
|-------|-----|---------|-------|
| Green | `#a6e3a1` | ![#a6e3a1](https://via.placeholder.com/50x20/a6e3a1/a6e3a1.png) | Success / Online |
| Yellow | `#f9e2af` | ![#f9e2af](https://via.placeholder.com/50x20/f9e2af/f9e2af.png) | Warning / Away |
| Red | `#f38ba8` | ![#f38ba8](https://via.placeholder.com/50x20/f38ba8/f38ba8.png) | Error |
| Sky | `#89dceb` | ![#89dceb](https://via.placeholder.com/50x20/89dceb/89dceb.png) | Info |
...
2. Open Steambrew settings and select "Catppuccin Mocha"
...
:root {
  ...
  --ctp-accent-primary: #89b4fa; /* Default blue */
  
  /* Change hover accent */
  --ctp-accent-hover: #74c7ec; /* Default sapphire */
  
  /* Change active accent */
  --ctp-accent-active: #b4befe; /* Default lavender */
}
```
